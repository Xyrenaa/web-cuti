<x-admin-layout>
    ...
    <!-- Diperbesar padding top-nya dari pt-10 ke pt-12 agar lebih berjarak dari header biru -->
    <div class="pt-12 pb-12">
        <!-- Diperbesar space-y-8 menjadi space-y-12 agar jarak antara welcome banner, card, dan tabel lebih lega -->
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-12">
            
            <!-- Welcome Banner (Tanpa Kotak & Menyatu dengan Background) -->
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end px-2 sm:px-0">
                ...
                <!-- Waktu Saat Ini Real-time dengan Alpine.js -->
                <div class="text-left md:text-right" 
                    ...
                    <!-- Teks diubah menjadi Waktu Saat Ini -->
            ...
            <!-- Stats Cards (Minimalis & Profesional) -->
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mt-6">
                ...
                <div class="p-4 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500 bg-gray-50/50">
                    <div class="mb-4 md:mb-0">Menampilkan 1-5 dari 42 pengajuan</div>
