...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-gray-900 bg-[#f8fafc] relative min-h-screen flex flex-col">
        ...
        <div class="relative z-10 flex-grow flex flex-col">
            ...
            <!-- Navbar Admin -->
            <!-- Diberikan efek sticky, z-50, transition, dan background blur saat di-scroll -->
            <nav x-data="{ open: false, scrolled: false }" 
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <!-- Kontainer mengecil dari h-20 menjadi h-16 saat di-scroll -->
                    <div class="flex justify-between items-center transition-all duration-300" :class="{'h-16': scrolled, 'h-20': !scrolled}">
                        ...
                        <!-- Tengah: Navigation Links (Tidak ada yang diubah sama sekali) -->
            ...
            <!-- Page Heading (Header Biru) - Ditambah relative z-40 agar tertutup navbar saat scroll -->
            @isset($header)
